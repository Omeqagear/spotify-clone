...
import { SimplifiedArtist } from '../models/simplified-artist';
import { SimplifiedAlbum } from '../models/simplified-album';
import { SimplifiedTrack } from '../models/simplified-track';
...
export class PlayerService {
  ...
  playAlbum(album: SimplifiedAlbum, trackID?: string): Promise<boolean> {
